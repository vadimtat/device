...
/******/ ({
  ...
  /***/ (function(module, __webpack_exports__, __webpack_require__) {
    ...
    /* harmony import */ const _utils_ios_vh_fix__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils/ios-vh-fix */ './js/utils/ios-vh-fix.js');
    /* harmony import */ const _modules_modals_init_modals__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/modals/init-modals */ './js/modules/modals/init-modals.js');
    ...
    function closePreviousAccordion(index) {
      return function () {
        if (openedAccordionOnMobile !== false && openedAccordionOnMobile !== index) {
    ...
    function updateSectionState() {
      const isWillBeExpanded = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
      hiddenElement.hidden = !isWillBeExpanded;
      trimmedElement.innerText = isWillBeExpanded ? savedTrimedText : getTrimmedText();
    }
    function getTrimmedText() {
      const _trimmedElement$datas = trimmedElement.dataset,
        trim = _trimmedElement$datas.trim,
        trimOn = _trimmedElement$datas.trimOn;
      if (trimOn === 'mobile') {
  ...
  /***/ (function(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_require__.r(__webpack_exports__);
    /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, 'modals', () => modals);
    /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, 'initModals', () => initModals);
    /* harmony import */ const _modals__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modals */ './js/modules/modals/modals.js');
  ...
  /***/ (function(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_require__.r(__webpack_exports__);
    /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, 'Modals', () => Modals);
    /* harmony import */ const _utils_scroll_lock__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../utils/scroll-lock */ './js/utils/scroll-lock.js');
    /* harmony import */ const _utils_focus_lock__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../utils/focus-lock */ './js/utils/focus-lock.js');
    ...
    var Modals = /*#__PURE__*/function () {
      ...
      _createClass(Modals, [{
        ...
        value: function _setSettings() {
          const settingKey = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this._settingKey;
        ...
        value: function open() {
          const _this = this;
          const modalName = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this._modalName;
          const modal = document.querySelector('[data-modal="'.concat(modalName, '"]'));
  ...
  /***/ (function(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_require__.r(__webpack_exports__);
    /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, 'FocusLock', () => FocusLock);
    function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError('Cannot call a class as a function'); } }
    function _defineProperties(target, props) { for (let i = 0; i < props.length; i++) { const descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ('value' in descriptor) {descriptor.writable = true;} Object.defineProperty(target, descriptor.key, descriptor); } }
    function _createClass(Constructor, protoProps, staticProps) { if (protoProps) {_defineProperties(Constructor.prototype, protoProps);} if (staticProps) {_defineProperties(Constructor, staticProps);} Object.defineProperty(Constructor, 'prototype', { writable: false }); return Constructor; }
    ...
    var FocusLock = /*#__PURE__*/function () {
      ...
      _createClass(FocusLock, [{
        ...
        value: function lock(lockedSelector) {
          const startFocus = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
          this.unlock();
        ...
        value: function unlock() {
          const returnFocus = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
  ...
  /***/ (function(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_require__.r(__webpack_exports__);
    /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, 'iosChecker', () => iosChecker);
  ...
  /***/ (function(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_require__.r(__webpack_exports__);
    /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, 'iosVhFix', () => iosVhFix);
    /* harmony import */ const _ios_checker__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ios-checker */ './js/utils/ios-checker.js');
  ...
  /***/ (function(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_require__.r(__webpack_exports__);
    /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, 'ScrollLock', () => ScrollLock);
    /* harmony import */ const _ios_checker__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ios-checker */ './js/utils/ios-checker.js');
    function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError('Cannot call a class as a function'); } }
    function _defineProperties(target, props) { for (let i = 0; i < props.length; i++) { const descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ('value' in descriptor) {descriptor.writable = true;} Object.defineProperty(target, descriptor.key, descriptor); } }
    function _createClass(Constructor, protoProps, staticProps) { if (protoProps) {_defineProperties(Constructor.prototype, protoProps);} if (staticProps) {_defineProperties(Constructor, staticProps);} Object.defineProperty(Constructor, 'prototype', { writable: false }); return Constructor; }
