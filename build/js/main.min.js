...
/* harmony import */ var _modules_valid__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/valid */ "./js/modules/valid.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_accordion__WEBPACK_IMPORTED_MODULE_2__["initAccordions"])();
  Object(_modules_about__WEBPACK_IMPORTED_MODULE_3__["initAbouts"])();
  Object(_modules_mask__WEBPACK_IMPORTED_MODULE_4__["initMaskPhone"])();
  Object(_modules_valid__WEBPACK_IMPORTED_MODULE_5__["initForms"])();
...
/*!*****************************!*\
  !*** ./js/modules/about.js ***!
  \*****************************/
/*! exports provided: initAbouts */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initAbouts", function() { return initAbouts; });
var hideSection = document.querySelector('.about__right-side');
var trigger = null;
var hiddenElement = null;
var trimmedElement = null;
var savedTrimedText = '';
function initAbouts() {
  if (hideSection) {
    ...
    trigger.addEventListener('click', function () {
      if (trigger) {
        var isWillBeExpanded = !checkIsExpanded();
...
function updateSectionState() {
  var isWillBeExpanded = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
...
function getTrimmedText() {
  if (trimmedElement && savedTrimedText) {
    var _trimmedElement$datas = trimmedElement.dataset,
...
var openedAccordionOnMobile = false;
var triggerClosePrevHandlers = Array.from({
  length: accordions.length
}, function (_, index) {
  return closePreviousAccordion(index);
});
...
/*!****************************!*\
  !*** ./js/modules/mask.js ***!
  \****************************/
/*! exports provided: initMaskPhone */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initMaskPhone", function() { return initMaskPhone; });
...
var maskPhone = document.querySelectorAll('.phone-us');
...
function initForm(form) {
  var phoneInput = form.querySelector('.phone-us');
  form.addEventListener('submit', function (event) {
    event.preventDefault();
    var phone = phoneInput.value;
    var isValid = checkPhone(phone);
    if (isValid) {
